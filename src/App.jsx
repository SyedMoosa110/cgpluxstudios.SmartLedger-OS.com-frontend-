  ...
  return <>
    ...
    <aside className={menuOpen ? 'sidebar open' : 'sidebar'}>
      ...
      <div style={{
        ...
        <p style={{ margin: '0 0 6px 0' }}>App Developed and update by:</p>
        <p style={{ margin: '0 0 6px 0', fontWeight: 'bold', fontSize: '12px', color: '#ffffff' }}>CGPLUX STUDIOS</p>
        <a href="https://cgpluxstudios.com/" target="_blank" rel="noopener noreferrer" style={{ color: '#38bdf8', textDecoration: 'none', display: 'block', marginBottom: '8px' }}>https://cgpluxstudios.com/</a>
        <p style={{ margin: '0 0 2px 0', fontWeight: 'bold' }}>Call us</p>
        <p style={{ margin: '0 0 8px 0' }}>+92 319 1086099</p>
        <p style={{ margin: '0 0 2px 0', fontWeight: 'bold' }}>Email us</p>
        <p style={{ margin: 0 }}>info@cgpluxstudios.com</p>
      </div>
    </aside>
    <main>
        ...
        <div className="modalOverlay" onClick={() => setActiveInvoice(null)}>
          <div className="printable-invoice" onClick={(e) => e.stopPropagation()}>
            <div className="invoice-header">
              <div className="invoice-brand" style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '4px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  ...
                  <h2 style={{ margin: 0 }}>{auth?.company_name || 'cgplux STUDIOS'}</h2>
                </div>
                {(auth?.company_address || auth?.company_phone) && (
                  <div style={{ fontSize: '12px', color: '#475569', lineHeight: '1.4', marginTop: '4px', textAlign: 'left' }}>
                    {auth?.company_address && <p style={{ margin: '0 0 2px 0' }}><strong>Address:</strong> {auth?.company_address}</p>}
                    {auth?.company_phone && <p style={{ margin: 0 }}><strong>Phone:</strong> {auth?.company_phone}</p>}
                  </div>
                )}
              </div>
            ...
            <div style={{ 
              ...
              <p style={{ margin: '0 0 4px 0', fontSize: '9px', textTransform: 'uppercase', letterSpacing: '0.5px', color: '#94a3b8' }}>Statement Generated by App</p>
              <p style={{ margin: '0 0 2px 0' }}>Developed & updated by:</p>
              <p style={{ margin: '0 0 2px 0', fontWeight: 'bold', fontSize: '13px', color: '#0f172a' }}>CGPLUX STUDIOS</p>
              <a href="https://cgpluxstudios.com/" target="_blank" rel="noopener noreferrer" style={{ color: '#0284c7', textDecoration: 'none', display: 'block', marginBottom: '4px', fontWeight: '500' }}>https://cgpluxstudios.com/</a>
              <div style={{ display: 'flex', justifyContent: 'center', gap: '15px', marginTop: '2px' }}>
                <span><strong>Call us:</strong> +92 319 1086099</span>
                <span><strong>Email us:</strong> info@cgpluxstudios.com</span>
              </div>
            </div>

            <div className="invoice-footer" style={{ marginTop: '15px' }}>
